...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#FFFFFF", paddingVertical: 40 },
  center: { flex: 1, alignItems: "center", paddingHorizontal: 28 },
  title: { fontSize: 30, fontWeight: "600", marginBottom: 4, color: "#111827" },
  subtitle: {
    fontSize: 15,
    color: "#6B7280",
    textAlign: "center",
